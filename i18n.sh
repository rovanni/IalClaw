...
_i18n_fallback() {
    ...
    case "$lang" in
        pt|pt-BR|pt_BR)
            ...
            I18N[prompt.restart_after_update]="O agente estava rodando antes da atualizacao. Deseja iniciar novamente agora? (s/n) [s]: "
            I18N[info.restart_skipped]="Reinicio ignorado. Voce pode iniciar depois com: node bin/ialclaw.js start --daemon"
        ...
        *)
            ...
            I18N[prompt.restart_after_update]="The agent was running before update. Do you want to start it again now? (y/n) [y]: "
            I18N[info.restart_skipped]="Restart skipped. You can start it later with: node bin/ialclaw.js start --daemon"
